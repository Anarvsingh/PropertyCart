...
var require_parse = __commonJS({
  "../../../../node_modules/css-what/lib/parse.js"(exports) {
    ...
    var traversalNames = new Set(__spreadArray2([
      "descendant"
...
var require_stringify = __commonJS({
  "../../../../node_modules/css-what/lib/stringify.js"(exports) {
    ...
    var charsToEscape = new Set(__spreadArray2(__spreadArray2([], Object.keys(actionTypes).map(function(typeKey) {
...
var require_lib3 = __commonJS({
  "../../../../node_modules/css-what/lib/index.js"(exports) {
    ...
    __exportStar2(require_parse(), exports);
    ...
    Object.defineProperty(exports, "stringify", { enumerable: true, get: function() {
      return __importDefault2(stringify_1).default;
    } });
  }
});
...
var require_lib9 = __commonJS({
  "../../../../node_modules/cheerio-select/lib/index.js"(exports) {
    ...
    var CUSTOM_SCOPE_PSEUDO = __assign2({}, SCOPE_PSEUDO);
    ...
    function filterBySelector(selector, elements, options) {
      ...
      if (selector.some(css_what_1.isTraversal)) {
        ...
        var sel = __spreadArray2(__spreadArray2([], selector), [CUSTOM_SCOPE_PSEUDO]);
    ...
    function select(selector, root, options) {
      ...
      return DomUtils.uniqueSort(results.reduce(function(a, b) {
        return __spreadArray2(__spreadArray2([], a), b);
      }));
    }
    ...
    function addContextIfScope(selector, options, scopeContext) {
      return scopeContext && selector.some(includesScopePseudo) ? __assign2(__assign2({}, options), { context: scopeContext }) : options;
    }
  ...
  "../../../../node_modules/parse5/lib/parser/formatting-element-list.js"(exports, module) {
    ...
    var FormattingElementList = class _FormattingElementList {
      ...
      getElementEntry(element) {
        for (let i = this.length - 1; i >= 0; i--) {
          const entry = this.entries[i];
          if (entry.type === _FormattingElementList.ELEMENT_ENTRY && entry.element === element) {
            return entry;
          }
        }
        return null;
    ...
    var Serializer = class _Serializer {
      ...
      _serializeAttributes(node) {
        ...
        for (let i = 0, attrsLength = attrs.length; i < attrsLength; i++) {
          const attr = attrs[i];
          const value = _Serializer.escapeString(attr.value, true);
          this.html += " ";
          if (!attr.namespace) {
            this.html += attr.name;
      ...
      _serializeTextNode(node) {
        ...
        if (parentTn === $.STYLE || parentTn === $.SCRIPT || parentTn === $.XMP || parentTn === $.IFRAME || parentTn === $.NOEMBED || parentTn === $.NOFRAMES || parentTn === $.PLAINTEXT || parentTn === $.NOSCRIPT) {
          ...
          this.html += _Serializer.escapeString(content, false);
        }
      }
...
export default require_traversing();
...
tslib/tslib.es6.js:
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=cheerio_lib_api_traversing.js.map
